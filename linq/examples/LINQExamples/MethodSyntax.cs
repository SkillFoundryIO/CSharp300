namespace LINQExamples
{
    public static class MethodSyntax
    {
        ...
        {
            var everyOtherEmployee = _employees
                .Where((e, index) => index % 2 == 0);
        ...
        {
            var firstEmployeeInCollection = _employees
                .First(e => e.Department == "IT");
        ...
        public static void First2()
        {
            ...
            var firstEmployeeInCollection = _employees
                .First(e => e.Department == "Fake");
            ConsoleIO.PrintEmployee(firstEmployeeInCollection, "This will error");
        }

        public static void Last()
        {
            var lastEmployeeInCollection = _employees
                .Where(e => e.Salary.HasValue)
                .OrderByDescending(e => e.Salary)
                .Last();
                
            ConsoleIO.PrintEmployee(lastEmployeeInCollection, "Lowest paid employee");
        }

        public static void FirstOrDefault()
        {
            var defaultEmployee = _employees
                .FirstOrDefault(e => e.Title == "Intern");
            ConsoleIO.PrintEmployee(defaultEmployee, "Default Null, No Interns");
        }
        public static void OrderingAscending()
        {
            var bySalaryDescending = _employees
                .Where(e => e.HourlyRate.HasValue)
        ...
        {
            // Normally, we would use var, but I want you to see the type.
            IEnumerable<IGrouping<string, Employee>> groupedEmployees = 
                _employees.GroupBy(e => e.Department);

            // outer loop: Groups (Departments)
            foreach(var group in groupedEmployees)
            {
                Console.WriteLine($"Department: {group.Key}");
                // inner loop: Employees in Department
        ...
        public static void SelectNonAnonymous()
        {
            var dropDownList = _employees.Select(e => 
            new DropDownItem(e.BadgeID, $"{e.LastName}, {e.FirstName}")
        );
        ...
        public static void Conversions()
        {
            ...
            var array = _employees
                .Where(e => e.Department == "IT")
                .ToArray();

            // Dictionary requires a key value
            var dictionary = _employees
                .Where(e => e.Department == "IT")
